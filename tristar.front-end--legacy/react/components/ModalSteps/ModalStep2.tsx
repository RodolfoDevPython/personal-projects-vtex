...
import Collapsible from '@vtex/styleguide/lib/Collapsible/index.js'
...
const ModalStep2 = (props: Props) => {
  ...
  return (
    <>
      <div className="modalHead modalHeadCollapsible" >
        <svg
          width="43"
          height="43"
          viewBox="0 0 43 43"
      ...
      <div className="modalBody modalBodyCollapsible" >
        <div className="tc">
          ...
          <Collapsible
            header={
              <div className="modalCollapsibleTitleContent">
                <span>
                  1.
                  <span className="modalCollapsibleTitle">
          ...
          >
            <div className="modalCollapsibleContent">
              <p className="mt0">
          ...
          >
            <div className="modalCollapsibleContent">
              ...
              <p>
                <strong className="modalCollapsibleContentTextBlue">
          ...
          >
            <div className="modalCollapsibleContent">
              ...
              <p className="modalCollapsibleContentTextBlue">
              ...
              <p className="modalCollapsibleContentTextRed">
      ...
      <div className="modalFooterCollapsible">
        <div className="modalFormFullButton">
