...
const ModalStepFormLogin = (props: Props) => {
  ...
  const account = Windows.jsnomeLoja
    ...
    <>
      ...
      <div className="modalBody">
        ...
        <div className="modalForm">
          <div className="flex-l w-100 modalForm2Input">
            ...
            <div className="vtex-input w-100 modalForm2InputCPF" >
              <span className="vtex-input__label db mb3 w-100 c-on-base t-small ">
                CPF
              </span>

              <div className="vtex-input-prefix__group flex flex-row items-stretch overflow-hidden br2 bw1 b--muted-4 hover-b--muted-3">
                <InputMask
                  mask="999.999.999-99"
                  maskChar={null}
                  value={document}
            ...
            (
              <div className="flex w-100">
                <a
                  ...
                  className="modalFormRedirectNotAuthorized"
